internal void update_camera(camera_t& camera, real32 dt)
{
    ...
    camera.calculated_direction.x = cos(camera.rotation.y * KC_DEG2RAD) * cos(-camera.rotation.z * KC_DEG2RAD);
    camera.calculated_direction.y = sin(-camera.rotation.z * KC_DEG2RAD);
    camera.calculated_direction.z = sin(camera.rotation.y * KC_DEG2RAD) * cos(-camera.rotation.z * KC_DEG2RAD);
