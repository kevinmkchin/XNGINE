...
// VAO VBO shader IDs
GLuint VAO, VBO, shader_program_id, uniform_x_move;
...
void CompileShaders()
{
	...
	uniform_x_move = glGetUniformLocation(shader_program_id, "x_move");
}
...
void Game::render()
{
	...
	// You can switch out shaders so you can draw different objects or scenes with different shader programs.
		...
		glUniform1f(uniform_x_move, tri_offset); // Set uniform variable of shader
